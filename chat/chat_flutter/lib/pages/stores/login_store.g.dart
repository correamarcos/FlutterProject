...
mixin _$LoginStore on _LoginStore, Store {
  ...
  bool get isVisiblePass =>
      (_$isVisiblePassComputed ??= Computed<bool>(() => super.isVisiblePass,
              name: '_LoginStore.isVisiblePass'))
          .value;
  ...
  late final _$isInvisiblePassAtom =
      Atom(name: '_LoginStore.isInvisiblePass', context: context);

  @override
  bool get isInvisiblePass {
    _$isInvisiblePassAtom.reportRead();
    return super.isInvisiblePass;
  }

  @override
  set isInvisiblePass(bool value) {
    _$isInvisiblePassAtom.reportWrite(value, super.isInvisiblePass, () {
      super.isInvisiblePass = value;
    });
  }
  ...
  void setPassword(String pPass) {
    ...
    try {
      return super.setPassword(pPass);
    } finally {
      _$_LoginStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void setPassVisibility() {
    final _$actionInfo = _$_LoginStoreActionController.startAction(
        name: '_LoginStore.setPassVisibility');
    try {
  ...
  String toString() {
    return '''
email: ${email},
isInvisiblePass: ${isInvisiblePass},
password: ${password},
loading: ${loading},
